...
string   sendPrologWebRequest(char* request, char* server, char* port, bool &status_result) {
	DWORD dwSize = 0;
...
void main_webRequest(void) {
	...
	string output = sendPrologWebRequest((char*)"/rtx_get?query=write(a)", (char*)"127.0.0.1", (char*)"8082", status_result);
